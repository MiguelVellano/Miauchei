...
<header>
  ...
  <main>
    ...
    <section id="anuncio">
      <h1>Perdeu seu pet? <br> Gostaria de anunciá-lo?</h1>
        ...
        <section class="image-card">
          ...
          <?php include('check_if_user_guard_this_post.php'); ?>
                            ...
                            <?php if($user_guard_this_post){ ?>
                                ...
                                <form action="unguard_this_post_animais_perdidos.php" method="POST" class="star" style="margin-top:-67%; margin-left: 94%;">
                            ...
                            <?php } else { ?>    
                                 <form action="guard_this_post_animais_perdidos.php" method="POST" class="star" style="margin-top:-67%; margin-left: 94%;">
                                     <input type="hidden" name="post_id" value="<?php echo $post['id'];?>">
