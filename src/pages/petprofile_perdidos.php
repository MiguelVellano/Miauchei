...
<header>
    <section class="header-content">
      ...
      <section class="action">
        <section class="profile">
            <img src="<?php echo "../images/testimodial/img/imagens_usuarios/".$_SESSION['image'];  ?>" alt='<img src="https://github.com/viniciusamc.png">' width="50" height="50">
        </section>
  ...
  <main>
    ...
    <section class="profile">
      ...
      <a class="find-pet" target="_blank" href="https://wa.me/5511992988091">Encontrei</a>
    </section>
      ...
      <section class="features">
        <table>
          <thead>
            ...
            <tr>
              <th><?php date("d-m-y", strtotime($post['date']));?></th>
            </tr>
          </thead>
  ...
  <section class="maps">
    ...
    <span class="close-window"><a href="animais_perdidos.php"><img src="../images/svg/arrowLeft.svg" alt=""></a></span>
    <?php } ?>
  </main>
